...
```{r, fig.height=7, fig.cap="Points represent simulated study iterations, averaging across all peaks for each task and contrast. "}
space |>
...
```{r, fig.height=7, fig.cap="Boxplots cover simulated study iterations, averaging across all peaks within each network (Yeo7), for each task and contrast."}
space |>
...
```{r, fig.height=10, fig.cap="Points represent peaks for peaks for each task and contrast, averaging across simulated study iterations."}
...
Average Distance Within Networks, With Effect Size
===
